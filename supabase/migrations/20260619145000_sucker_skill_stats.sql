alter table public.game_player_results
  add column if not exists blowout_win integer not null default 0,
  add column if not exists blowout_loss integer not null default 0,
  add column if not exists comeback_win integer not null default 0,
  add column if not exists extra_rolls_used integer not null default 0,
  add column if not exists sucker_hunts integer not null default 0,
  add column if not exists sucker_hunt_misses integer not null default 0,
  add column if not exists sucker_tokens_spent integer not null default 0,
  add column if not exists sucker_tokens_leftover integer not null default 0;
...
alter table public.head_to_head_stats
  ...
  add column if not exists sucker_hunt_misses integer not null default 0,
  add column if not exists sucker_tokens_spent integer not null default 0,
  add column if not exists average_sucker_tokens_spent numeric(8, 2) not null default 0,
  add column if not exists sucker_tokens_leftover integer not null default 0,
  add column if not exists average_sucker_tokens_leftover numeric(8, 2) not null default 0;
...
alter table public.computer_stats
  ...
  add column if not exists comeback_wins integer not null default 0,
  add column if not exists extra_rolls_used integer not null default 0,
  add column if not exists mulligans_used integer not null default 0,
  add column if not exists sucker_hunts integer not null default 0,
  add column if not exists sucker_hunt_misses integer not null default 0,
  add column if not exists sucker_punches_used integer not null default 0,
  add column if not exists sucker_blockers_used integer not null default 0,
  add column if not exists sucker_tokens_spent integer not null default 0,
  add column if not exists average_sucker_tokens_spent numeric(8, 2) not null default 0,
  add column if not exists sucker_tokens_leftover integer not null default 0,
  add column if not exists average_sucker_tokens_leftover numeric(8, 2) not null default 0;

drop view if exists public.head_to_head_stat_rates;
