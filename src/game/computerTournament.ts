...
function strategyKey(strategy: ComputerStrategyConfig) {
  return JSON.stringify({
    ...
    decisionRolloutUseCommonRandomFutures: strategy.decisionRolloutUseCommonRandomFutures,
    ...
    faceChaseCountWeight: strategy.faceChaseCountWeight,
    faceChaseFourOfAKindValue: strategy.faceChaseFourOfAKindValue,
    faceChasePipWeight: strategy.faceChasePipWeight,
    faceChaseSuckerValue: strategy.faceChaseSuckerValue,
    faceChaseThreeOfAKindValue: strategy.faceChaseThreeOfAKindValue,
    ...
    holdRolloutUseActualScoreDelta: strategy.holdRolloutUseActualScoreDelta,
    mulliganMaxScore: strategy.mulliganMaxScore,
    opportunityCostChance: strategy.opportunityCostChance,
    opportunityCostFourOfAKind: strategy.opportunityCostFourOfAKind,
    opportunityCostFullHouse: strategy.opportunityCostFullHouse,
    opportunityCostLargeStraight: strategy.opportunityCostLargeStraight,
    opportunityCostSmallStraight: strategy.opportunityCostSmallStraight,
    ...
    suckerDealMaxTokens: strategy.suckerDealMaxTokens,
